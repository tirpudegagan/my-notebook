...
### **Phase 1: Get Comfortable with Computers**

1. **Basic Computer Skills**
    
    - Understand how to use operating systems (Windows or macOS).
    - Learn basic file operations: creating, moving, copying, deleting files and folders.
    - Familiarize yourself with keyboard shortcuts and text editors (like Notepad or Notepad++).
2. **Understanding the Internet and Software Installation**
    
    - Learn how to search for information online, find software resources, and download/install software.
    - Install a Java IDE, such as Eclipse or IntelliJ, with assistance if needed.


---

## **[[OIM Teams/2) Computer Fundamentals\|Phase 2: Computing Fundamentals]]**
